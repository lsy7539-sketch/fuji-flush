...
export type ServerMessage =
  | { type: "roomCreated"; roomCode: string; youAre: string }
  | { type: "roomJoined"; roomCode: string; youAre: string }
  | { type: "lobbyUpdate"; roomCode: string; hostId: string; players: LobbyPlayer[] }
